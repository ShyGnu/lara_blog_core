                ...
                <div class="card-body">
                    ...
                    {{Form::open([
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-line" name="title" value="{{old('title')}}"> <span class="help-block text-muted"><small>Введите заголовок Новости.</small></span> </div>
                        ...
                        <div class="form-group">
                            <div class="row form-material">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="2017-06-04" id="mdate" name="date" value="{{old('date')}}">
                        ...
                        <div class="form-group">
                            <input type="checkbox" id="basic_checkbox_1"  name="is_features"/>

...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Дальше",sPrevious:"Назад"},sEmptyTable:"No data available in table",sInfo:"Показано с _START_ по _END_ из _TOTAL_ записей",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(отфильтровано из _MAX_ записей)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Отобразить _MENU_ записей",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},
